          ...
          <table class="cart-table">
            ...
            <tbody>
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="../images/cart-item-1.php" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="../images/cart-item-2.php" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
                  <div class="shopping-cart__product-item__detail">
              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="../images/cart-item-3.php" width="120" height="120" alt="" />
                  </div>
                </td>
                <td>
                  <div class="shopping-cart__product-item__detail">
